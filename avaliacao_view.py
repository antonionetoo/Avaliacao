...
class TelaAvaliacao():
    ...
    def options_better_model(self):    
        ...
        self.txt_choose_better_model.grid(row = 10, column = 4)
        
        self.best_model = ttk.Combobox(self.window, values = ['Nenhum', 'Modelo 1', 'Modelo 2'], state="readonly", width = 15)
        self.best_model.grid(row = 10, column = 5, sticky = constants.W + constants.E)
    ...
    def save_and_open_file(self):
        ...
        self.btn_abrir_arquivo.grid(row = 20, column = 5, sticky = constants.W)
