...
class TelaAvaliacao():
    ...
    def navegation(self):
        ...
        self.lb_referencia_deanon.grid(row = 20, column = 2, sticky = constants.W)
        ...
        self.lb_identifier.grid(row = 20, column = 3, sticky = constants.W)
        
        self.txt_identifier = Entry(self.window, width = 17)
        self.txt_identifier.grid(row = 21, column = 3, sticky = constants.W)
    ...
    def options_better_model(self):    
        ...
        self.best_model.set(1)
        
        option_model1 = Radiobutton(self.window, text='Modelo 1', variable = self.best_model, value = 1)
        option_model1.grid(row = 8, column = 6)

        option_model2 = Radiobutton(self.window, text='Modelo 2', variable = self.best_model, value = 2)
    ...
    def save_and_open_file(self):
        ...
        self.btn_abrir_arquivo.grid(row = 20, column = 7, sticky = constants.W)
